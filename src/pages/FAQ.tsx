...
const FAQ = () => {
      ...
      faqs: [
        {
          ...
          answer: "We provide the birth application forms which is filled by the parents/Guardian then taken to the nearest Huduma centre"
        },
        {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-green-600 via-black to-red-600 text-white py-25">
